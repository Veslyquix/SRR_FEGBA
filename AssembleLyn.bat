...
if exist "FE6_defs.s" (
	...
	%as% -g -mcpu=arm7tdmi -mthumb-interwork "FE6_defs.s" -o "%~dp0Patches/FE6_defs.elf"
...
if exist "FE7_defs.s" (
	...
	@rem Assemble definitions into a .elf if exists	
	%as% -g -mcpu=arm7tdmi -mthumb-interwork "FE7_defs.s" -o "%~dp0Patches/FE7_defs.elf"
...
if exist "FE8_defs.s" (
	...
	@rem Assemble definitions into a .elf if exists	
	%as% -g -mcpu=arm7tdmi -mthumb-interwork "FE8_defs.s" -o "%~dp0Patches/FE8_defs.elf"
